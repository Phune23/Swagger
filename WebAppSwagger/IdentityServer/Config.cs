...
namespace WebAppSwagger.IdentityServer
{
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> Apis =>
            new ApiResource[]
            {
                new ApiResource("api.WebChatSwagger", "WebChatSwagger API")
            };
        ...
        new ApiScope[]
        {
                new ApiScope("api.WebChatSwagger", "WebChatSwagger API")
        };
