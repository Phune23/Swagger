using WebAppSwagger.Data;
using WebAppSwagger.Data.Entities;
using WebAppSwagger.IdentityServer;
using WebAppSwagger.Services;
...
namespace WebAppSwagger
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                option.ExpectedScope = "api.WebChatSwagger";
            });
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "WebChatSwagger Space Api", Version = "v1" });
                c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme
                {
                    ...
                    Flows = new OpenApiOAuthFlows
                    {
                        Implicit = new OpenApiOAuthFlow
                        {
                            ...
                            Scopes = new Dictionary<string, string> { { "api.WebChatSwagger", "WebChatSwagger API" } }
                        },
                    },
                });
                ...
                {
                    {
                        ...
                        new List<string>{ "api.WebChatSwagger" }
                    }
                });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "WebChatSwagger Space Api V1");
            });
